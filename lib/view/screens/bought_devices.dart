...
class BoughtDevices extends StatefulWidget {
  const BoughtDevices({Key? key}) : super(key: key);

  @override
  State<BoughtDevices> createState() => _BoughtDevicesState();
}

class _BoughtDevicesState extends State<BoughtDevices> {
  ...
  // Future<void> getDevicesHistoryList() async
  // {
  //   setState(() {
  //     pageIsLoading = true;
  //   });
  //   await FirebaseFirestore.instance.collection("DevicesHistory")
  //       .where("buyer",isEqualTo: FirebaseAuth.instance.currentUser!.uid)
  //       .orderBy("date",descending: true)
  //       .get().then((value) {
