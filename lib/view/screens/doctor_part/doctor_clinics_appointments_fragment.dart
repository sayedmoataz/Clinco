...
class DoctorClinicsAppointmentsFragment extends StatefulWidget {
  const DoctorClinicsAppointmentsFragment({Key? key}) : super(key: key);

  @override
  _DoctorClinicsAppointmentsFragmentState createState() =>
      _DoctorClinicsAppointmentsFragmentState();
}

class _DoctorClinicsAppointmentsFragmentState
    extends State<DoctorClinicsAppointmentsFragment> {
        ...
        if (snapshot.hasData) {
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, i) {
                return _buildDoctorAppointmentWidget(_bookingRequests[i],
  ...
  _buildDoctorAppointmentWidget(BookingRequest bookingRequest,
