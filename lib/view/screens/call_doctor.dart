                                              ...
                                              child: Text(clinics[i].name ?? '',
                                                  ...
                                                  style: const TextStyle(
                                                      ...
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      color: Colors.white))),
                                          // Flexible(flex: 2, fit:  FlexFit.loose, child: Text(clinics[i]. ?? '', overflow: TextOverflow.ellipsis, maxLines: 1, textDirection: TextDirection.rtl, style: const TextStyle(fontSize: 16.0, fontWeight: FontWeight.bold, color: Colors.black))),
                                          const Spacer(
                                            flex: 1,
                                          ),
                                          Flexible(
