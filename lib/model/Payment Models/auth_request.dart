...
class Profile {
    ...
    dynamic isMobadra;
    dynamic sector;
    dynamic activationMethod;
    dynamic signedUpThrough;
    dynamic failedAttempts;
    List<dynamic>? customExportColumns;
    List<dynamic>? serverIp;
    dynamic username;
    dynamic primaryPhoneNumber;
    dynamic primaryPhoneVerified;
    dynamic isTempPassword;
    dynamic otpSentAt;
    dynamic otpSentTo;
    ...
    dynamic deliveryStatusCallback;
    dynamic merchantExternalLink;
    dynamic merchantStatus;
    dynamic deactivatedByBank;
    dynamic bankDeactivationReason;
    dynamic bankMerchantStatus;
    dynamic nationalId;
    dynamic superAgent;
    ...
    dynamic allowTerminalOrderId;
    dynamic allowEncryptionBypass;
    ...
    dynamic bankReceivedDocuments;
    dynamic bankMerchantDigitalStatus;
    dynamic bankDigitalRejectionReason;
    dynamic filledBusinessData;
    dynamic dayStartTime;
    dynamic dayEndTime;
    dynamic withholdTransfers;
    dynamic smsSenderName;
    dynamic withholdTransfersReason;
    dynamic withholdTransfersNotes;
    dynamic canBillDepositWithCard;
    dynamic canTopupMerchants;
    dynamic topupTransferId;
    dynamic referralEligible;
    dynamic paymobAppMerchant;
    dynamic settlementFrequency;
    dynamic dayOfTheWeek;
    dynamic dayOfTheMonth;
    dynamic allowTransactionNotifications;
    dynamic allowTransferNotifications;
    dynamic sallefnyAmountWhole;
    dynamic sallefnyFeesWhole;
